...
set_include_path('.'.PATH_SEPARATOR.'.'.DIRECTORY_SEPARATOR.'public'.DIRECTORY_SEPARATOR.'lib'.PATH_SEPARATOR.'.'.DIRECTORY_SEPARATOR.'lib'.PATH_SEPARATOR.dirname(__FILE__).'/lib');
