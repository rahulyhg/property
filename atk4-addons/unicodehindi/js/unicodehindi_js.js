$.each({
    ...
    krutidev_to_unicode: function(unicode_field, krudidev_field) {
        unicode_field = unicode_field.substring(1);
        krudidev_field = krudidev_field.substring(1);
        ...
        var modified_substring = document.getElementById(krudidev_field).value;

        //****************************************************************************************
        //  Break the long text into small bunches of max. max_text_size  characters each.
        //****************************************************************************************
        var text_size = document.getElementById(krudidev_field).value.length;
        ...
        while (chale_chalo == 1) {
            ...
            if (sthiti2 < (text_size - max_text_size)) {
                ...
                while (document.getElementById(krudidev_field).value.charAt(sthiti2) != ' ') {
                    sthiti2--;
                }
            } else {
                sthiti2 = text_size;
            ...
            var modified_substring = document.getElementById(krudidev_field).value.substring(sthiti1, sthiti2);
            ...
            document.getElementById(unicode_field).value = processed_text;
        }
...
*/
    ...
    unicode_to_krutidev: function(unicode_field, krudidev_field) {
        unicode_field = unicode_field.substring(1);
        krudidev_field = krudidev_field.substring(1);
        var array_one = new Array(
        ...
        var array_one_length = array_one.length;
        console.log(unicode_field);
        var modified_substring = document.getElementById(unicode_field).value;

        //****************************************************************************************
        //  Break the long text into small bunches of max. max_text_size  characters each.
        //****************************************************************************************
        var text_size = document.getElementById(unicode_field).value.length;
        ...
        while (chale_chalo == 1) {
            ...
            if (sthiti2 < (text_size - max_text_size)) {
                sthiti2 += max_text_size;
                while (document.getElementById(unicode_field).value.charAt(sthiti2) != ' ') {
                    sthiti2--;
                }
            } else {
                sthiti2 = text_size;
            ...
            var modified_substring = document.getElementById(unicode_field).value.substring(sthiti1, sthiti2);
            ...
            document.getElementById(krudidev_field).value = processed_text;
        }
